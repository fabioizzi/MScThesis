/*
 * File: GeneralLopes_ParseString.c
 *
 *
  *
...
#define S_FUNCTION_NAME GeneralLopes_ParseString
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      s
#define INPUT_0_WIDTH       1500
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      isParseException
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      llcState
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      blueCabinetButtonPressed
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      isInitOk
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      isMotorsOk
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      isTreadmillEmpty
...
/* Output Port  6 */
#define OUT_PORT_6_NAME      isPatientDefined
...
extern void GeneralLopes_ParseString_Outputs_wrapper(const uint8_T *s,
                          const real_T *s_len,
...
{
    const uint8_T   *s  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const real_T   *s_len  = (const real_T*) ssGetInputPortSignal(S,1);
    real_T        *isParseException  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *llcState  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *blueCabinetButtonPressed  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *isInitOk  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *isMotorsOk  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *isTreadmillEmpty  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *isPatientDefined  = (real_T *)ssGetOutputPortRealSignal(S,6);

    GeneralLopes_ParseString_Outputs_wrapper(s, s_len, isParseException, llcState, blueCabinetButtonPressed, isInitOk, isMotorsOk, isTreadmillEmpty, isPatientDefined);
}

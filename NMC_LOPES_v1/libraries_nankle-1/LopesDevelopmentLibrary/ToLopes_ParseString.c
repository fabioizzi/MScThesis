 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Dec 15 15:03:16 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ToLopes_ParseString
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      ErrorValue
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      SpringSpringDidntExist
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      BiasForceSpringDidntExist
...
extern void ToLopes_ParseString_Outputs_wrapper(const uint8_T *s,
			const real_T *s_len,
			real_T *ErrorValue,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T        *ErrorValue  = (real_T *)ssGetOutputPortRealSignal(S,0);
    boolean_T        *SpringSpringDidntExist  = (boolean_T *)ssGetOutputPortRealSignal(S,1);
    boolean_T        *BiasForceSpringDidntExist  = (boolean_T *)ssGetOutputPortRealSignal(S,2);

    ToLopes_ParseString_Outputs_wrapper(s, s_len, ErrorValue, SpringSpringDidntExist, BiasForceSpringDidntExist);

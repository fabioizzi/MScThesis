/*
 * File: GeneralLopes_GenerateString.c
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Dec 15 14:36:29 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GeneralLopes_GenerateString
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          6
/* Input Port  0 */
#define IN_PORT_0_NAME      DesiredState
...
/* Input Port  1 */
#define IN_PORT_1_NAME      DesiredStateChanged
...
/* Input Port  2 */
#define IN_PORT_2_NAME      SegmentInertia
...
/* Input Port  3 */
#define IN_PORT_3_NAME      SegmentInertiaChanged
...
/* Input Port  4 */
#define IN_PORT_4_NAME      WatchdogTimeout
...
extern void GeneralLopes_GenerateString_Outputs_wrapper(const real_T *DesiredState,
...
{
    const real_T   *DesiredState  = (const real_T*) ssGetInputPortSignal(S,0);
    const boolean_T   *DesiredStateChanged  = (const boolean_T*) ssGetInputPortSignal(S,1);
    const real_T   *SegmentInertia  = (const real_T*) ssGetInputPortSignal(S,2);
    const boolean_T   *SegmentInertiaChanged  = (const boolean_T*) ssGetInputPortSignal(S,3);
    const real_T   *WatchdogTimeout  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *i  = (const real_T*) ssGetInputPortSignal(S,5);
    uint8_T        *s  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *s_len  = (real_T *)ssGetOutputPortRealSignal(S,1);

    GeneralLopes_GenerateString_Outputs_wrapper(DesiredState, DesiredStateChanged, SegmentInertia, SegmentInertiaChanged, WatchdogTimeout, i, s, s_len);

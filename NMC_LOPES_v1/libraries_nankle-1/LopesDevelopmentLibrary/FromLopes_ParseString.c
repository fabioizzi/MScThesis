 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Feb 11 12:32:28 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME FromLopes_ParseString
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      cntExpected
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      segmentModelPos
#define OUTPUT_3_WIDTH       15
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      segmentModelVel
#define OUTPUT_4_WIDTH       15
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      segmentModelAcc
#define OUTPUT_5_WIDTH       15
...
/* Output Port  6 */
#define OUT_PORT_6_NAME      segmentMeasPos
#define OUTPUT_6_WIDTH       15
...
/* Output Port  7 */
#define OUT_PORT_7_NAME      segmentMeasForce
#define OUTPUT_7_WIDTH       10
...
/* Output Port  8 */
#define OUT_PORT_8_NAME      cartesianModelPos
#define OUTPUT_8_WIDTH       33
...
/* Output Port  9 */
#define OUT_PORT_9_NAME      treadmill
...
/* Output Port  10 */
#define OUT_PORT_10_NAME      analogInput
...
extern void FromLopes_ParseString_Outputs_wrapper(const uint8_T *str,
			const real_T *len,
			real_T *msgId,
			real_T *cnt,
			real_T *cntExpected,
...
{
    const uint8_T   *str  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const real_T   *len  = (const real_T*) ssGetInputPortSignal(S,1);
    real_T        *msgId  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *cnt  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *cntExpected  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *segmentModelPos  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *segmentModelVel  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *segmentModelAcc  = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *segmentMeasPos  = (real_T *)ssGetOutputPortRealSignal(S,6);
    real_T        *segmentMeasForce  = (real_T *)ssGetOutputPortRealSignal(S,7);
    real_T        *cartesianModelPos  = (real_T *)ssGetOutputPortRealSignal(S,8);
    real_T        *treadmill  = (real_T *)ssGetOutputPortRealSignal(S,9);
    real_T        *analogInput  = (real_T *)ssGetOutputPortRealSignal(S,10);
    const int_T        u_width = ssGetInputPortWidth(S,0);

    FromLopes_ParseString_Outputs_wrapper(str, len, msgId, cnt, cntExpected, segmentModelPos, segmentModelVel, segmentModelAcc, segmentMeasPos, segmentMeasForce, cartesianModelPos, treadmill, analogInput, u_width);
